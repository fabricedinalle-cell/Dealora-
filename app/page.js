 ...
 return <main className="min-h-screen bg-white text-[#111] pb-20 md:pb-0">
  ...
  <section className="mx-auto max-w-7xl px-4 md:px-8">
   <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-[#effff7] via-[#eafff3] to-[#dff8e9] px-1 pb-3 md:grid md:grid-cols-2 md:items-center md:px-8">
    <div className="relative z-10 px-3 pt-6 md:px-0 md:py-12">
    ...
    <div className="relative mt-4 h-[285px] md:mt-5 md:h-[360px]">
      ...
      <img className="absolute bottom-[8%] left-[4%] h-[50%] w-[37%] rotate-[-4deg] rounded-[28px] object-cover shadow-xl" src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=600&q=85" alt="Sac vert"/>
   ...
   <div className="mt-8 flex items-center justify-between"><h2 className="text-xl font-black">Annonces récentes</h2><button className="text-xs font-bold text-[#078a49]">Voir toutes →</button></div>
